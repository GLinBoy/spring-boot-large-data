package com.glinboy.largedata.dataprovider
...
class DataProviderApplication {
	...
	companion object {
		...
		fun main(args: Array<String>) {
			val env = runApplication<DataProviderApplication>(*args).environment
			logApplicationStartup(env)
		}

		@JvmStatic
		fun logApplicationStartup(env: Environment) {
			val log = LoggerFactory.getLogger(DataProviderApplication::class.java)
